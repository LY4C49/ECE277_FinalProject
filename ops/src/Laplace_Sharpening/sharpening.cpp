...
void sharpening_gpu(at::Tensor a_tensor, at::Tensor b_tensor, at::Tensor c_tensor){
...
//float(*a)[3] = new float[2][3];
    ...
    sharpening_launcher(a, b, c, n);
}


PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  m.def("forward", &sharpening_gpu, "sum two arrays (CUDA)");
}